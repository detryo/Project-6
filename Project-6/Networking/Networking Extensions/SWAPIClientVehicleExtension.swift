//
//  SWAPIClientVehicleExtension.swift
//  Project-6
//
...
extension SWAPIClient {
    func getListOfVehicles(page: Int, completionHandler completion: @escaping (Vehicles?, Error?) -> Void) {
        decoder.keyDecodingStrategy = .convertFromSnakeCase
        guard let url = URL(string: "https://swapi.co/api/vehicles/?page=\(page)") else {
